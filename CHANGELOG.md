...
- added the transparent Archive forge avatar to the root `README.md` header for clearer project branding
...
- added a reusable `512x512` forge avatar asset under `.vitepress/public/brand/`
