...
- added local-search tag queries like exact `#proxmox` and prefix `#proxm*`, which return the generated tag page plus pages explicitly tagged with matching terms
