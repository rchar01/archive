...
- `tags`: optional list of tags; generated pages render them in the Context panel as links to generated `/tags/...` pages, and local search can target them directly with queries like `#proxmox`
